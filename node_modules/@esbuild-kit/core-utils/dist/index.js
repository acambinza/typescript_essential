"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var Pt=require("source-map-support"),Xt=require("url"),ne=require("esbuild"),Tt=require("crypto"),$t=require("fs"),Zt=require("path"),Wt=require("os");function T(i){return i&&typeof i=="object"&&"default"in i?i:{default:i}}var Vt=T(Pt),zt=T(Tt),Y=T($t),_=T(Zt),eA=T(Wt);const tA=`
//# sourceMappingURL=data:application/json;base64,`;function AA(){if("setSourceMapsEnabled"in process&&typeof Error.prepareStackTrace!="function")return process.setSourceMapsEnabled(!0),({code:A,map:r})=>A+tA+Buffer.from(JSON.stringify(r),"utf8").toString("base64");const e=new Map;return Vt.default.install({environment:"node",retrieveSourceMap(A){const r=e.get(A);return r?{url:A,map:r}:null}}),({code:A,map:r},s)=>(e.set(s,r),A)}const Fe=i=>zt.default.createHash("sha1").update(i).digest("hex"),Ue=",".charCodeAt(0),nA=";".charCodeAt(0),xe="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",qe=new Uint8Array(64),Me=new Uint8Array(128);for(let i=0;i<xe.length;i++){const e=xe.charCodeAt(i);qe[i]=e,Me[e]=i}const de=typeof TextDecoder<"u"?new TextDecoder:typeof Buffer<"u"?{decode(i){return Buffer.from(i.buffer,i.byteOffset,i.byteLength).toString()}}:{decode(i){let e="";for(let A=0;A<i.length;A++)e+=String.fromCharCode(i[A]);return e}};function rA(i){const e=new Int32Array(5),A=[];let r=0;do{const s=iA(i,r),a=[];let c=!0,C=0;e[0]=0;for(let h=r;h<s;h++){let g;h=$(i,h,e,0);const Q=e[0];Q<C&&(c=!1),C=Q,Ge(i,h,s)?(h=$(i,h,e,1),h=$(i,h,e,2),h=$(i,h,e,3),Ge(i,h,s)?(h=$(i,h,e,4),g=[Q,e[1],e[2],e[3],e[4]]):g=[Q,e[1],e[2],e[3]]):g=[Q],a.push(g)}c||sA(a),A.push(a),r=s+1}while(r<=i.length);return A}function iA(i,e){const A=i.indexOf(";",e);return A===-1?i.length:A}function $(i,e,A,r){let s=0,a=0,c=0;do{const h=i.charCodeAt(e++);c=Me[h],s|=(c&31)<<a,a+=5}while(c&32);const C=s&1;return s>>>=1,C&&(s=-2147483648|-s),A[r]+=s,e}function Ge(i,e,A){return e>=A?!1:i.charCodeAt(e)!==Ue}function sA(i){i.sort(oA)}function oA(i,e){return i[0]-e[0]}function Ye(i){const e=new Int32Array(5),A=1024*16,r=A-36,s=new Uint8Array(A),a=s.subarray(0,r);let c=0,C="";for(let h=0;h<i.length;h++){const g=i[h];if(h>0&&(c===A&&(C+=de.decode(s),c=0),s[c++]=nA),g.length!==0){e[0]=0;for(let Q=0;Q<g.length;Q++){const n=g[Q];c>r&&(C+=de.decode(a),s.copyWithin(0,r,c),c-=r),Q>0&&(s[c++]=Ue),c=Z(s,c,e,n,0),n.length!==1&&(c=Z(s,c,e,n,1),c=Z(s,c,e,n,2),c=Z(s,c,e,n,3),n.length!==4&&(c=Z(s,c,e,n,4)))}}}return C+de.decode(s.subarray(0,c))}function Z(i,e,A,r,s){const a=r[s];let c=a-A[s];A[s]=a,c=c<0?-c<<1|1:c<<1;do{let C=c&31;c>>>=5,c>0&&(C|=32),i[e++]=qe[C]}while(c>0);return e}class ce{constructor(e){this.bits=e instanceof ce?e.bits.slice():[]}add(e){this.bits[e>>5]|=1<<(e&31)}has(e){return!!(this.bits[e>>5]&1<<(e&31))}}class z{constructor(e,A,r){this.start=e,this.end=A,this.original=r,this.intro="",this.outro="",this.content=r,this.storeName=!1,this.edited=!1,this.previous=null,this.next=null}appendLeft(e){this.outro+=e}appendRight(e){this.intro=this.intro+e}clone(){const e=new z(this.start,this.end,this.original);return e.intro=this.intro,e.outro=this.outro,e.content=this.content,e.storeName=this.storeName,e.edited=this.edited,e}contains(e){return this.start<e&&e<this.end}eachNext(e){let A=this;for(;A;)e(A),A=A.next}eachPrevious(e){let A=this;for(;A;)e(A),A=A.previous}edit(e,A,r){return this.content=e,r||(this.intro="",this.outro=""),this.storeName=A,this.edited=!0,this}prependLeft(e){this.outro=e+this.outro}prependRight(e){this.intro=e+this.intro}split(e){const A=e-this.start,r=this.original.slice(0,A),s=this.original.slice(A);this.original=r;const a=new z(e,this.end,s);return a.outro=this.outro,this.outro="",this.end=e,this.edited?(a.edit("",!1),this.content=""):this.content=r,a.next=this.next,a.next&&(a.next.previous=a),a.previous=this,this.next=a,a}toString(){return this.intro+this.content+this.outro}trimEnd(e){if(this.outro=this.outro.replace(e,""),this.outro.length)return!0;const A=this.content.replace(e,"");if(A.length)return A!==this.content&&(this.split(this.start+A.length).edit("",void 0,!0),this.edited&&this.edit(A,this.storeName,!0)),!0;if(this.edit("",void 0,!0),this.intro=this.intro.replace(e,""),this.intro.length)return!0}trimStart(e){if(this.intro=this.intro.replace(e,""),this.intro.length)return!0;const A=this.content.replace(e,"");if(A.length){if(A!==this.content){const r=this.split(this.end-A.length);this.edited&&r.edit(A,this.storeName,!0),this.edit("",void 0,!0)}return!0}else if(this.edit("",void 0,!0),this.outro=this.outro.replace(e,""),this.outro.length)return!0}}function aA(){return typeof window<"u"&&typeof window.btoa=="function"?i=>window.btoa(unescape(encodeURIComponent(i))):typeof Buffer=="function"?i=>Buffer.from(i,"utf-8").toString("base64"):()=>{throw new Error("Unsupported environment: `window.btoa` or `Buffer` should be supported.")}}const cA=aA();class uA{constructor(e){this.version=3,this.file=e.file,this.sources=e.sources,this.sourcesContent=e.sourcesContent,this.names=e.names,this.mappings=Ye(e.mappings),typeof e.x_google_ignoreList<"u"&&(this.x_google_ignoreList=e.x_google_ignoreList)}toString(){return JSON.stringify(this)}toUrl(){return"data:application/json;charset=utf-8;base64,"+cA(this.toString())}}function lA(i){const e=i.split(`
`),A=e.filter(a=>/^\t+/.test(a)),r=e.filter(a=>/^ {2,}/.test(a));if(A.length===0&&r.length===0)return null;if(A.length>=r.length)return"	";const s=r.reduce((a,c)=>{const C=/^ +/.exec(c)[0].length;return Math.min(C,a)},1/0);return new Array(s+1).join(" ")}function QA(i,e){const A=i.split(/[/\\]/),r=e.split(/[/\\]/);for(A.pop();A[0]===r[0];)A.shift(),r.shift();if(A.length){let s=A.length;for(;s--;)A[s]=".."}return A.concat(r).join("/")}const hA=Object.prototype.toString;function fA(i){return hA.call(i)==="[object Object]"}function _e(i){const e=i.split(`
`),A=[];for(let r=0,s=0;r<e.length;r++)A.push(s),s+=e[r].length+1;return function(s){let a=0,c=A.length;for(;a<c;){const g=a+c>>1;s<A[g]?c=g:a=g+1}const C=a-1,h=s-A[C];return{line:C,column:h}}}const gA=/\w/;class CA{constructor(e){this.hires=e,this.generatedCodeLine=0,this.generatedCodeColumn=0,this.raw=[],this.rawSegments=this.raw[this.generatedCodeLine]=[],this.pending=null}addEdit(e,A,r,s){if(A.length){const a=[this.generatedCodeColumn,e,r.line,r.column];s>=0&&a.push(s),this.rawSegments.push(a)}else this.pending&&this.rawSegments.push(this.pending);this.advance(A),this.pending=null}addUneditedChunk(e,A,r,s,a){let c=A.start,C=!0,h=!1;for(;c<A.end;){if(this.hires||C||a.has(c)){const g=[this.generatedCodeColumn,e,s.line,s.column];this.hires==="boundary"?gA.test(r[c])?h||(this.rawSegments.push(g),h=!0):(this.rawSegments.push(g),h=!1):this.rawSegments.push(g)}r[c]===`
...
`,d-1)}`),{idx:d})}let Te=!1;He.then(()=>{Te=!0});const pA=i=>Te?Oe(i):kA(i),bA=`.then((mod)=>{
